...
$(document).ready(function() {
    if(screenWidth <= 1100) {
        Swal.fire({
            ...
            icon: 'error',
            title: 'Oops...',
            text: 'NÃ£o Ã© possÃ­vel utilizar a nossa ferramenta de personalizaÃ§Ã£o em dispositivos mobile :(',
            footer: '<a href="https://www.meucopoeco.com.br/site/compra"></a>'
        }).then((result) => {
            if (result.isConfirmed) {
                window.location.href = 'https://www.meucopoeco.com.br/site/compra';
