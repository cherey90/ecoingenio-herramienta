            ...
            html2canvas(document.querySelector("div#html2canvas"), { scale: 2 }).then((canvas) => {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("div#boxAprovacao iframe").attr("src", "https://ecovasos.com/qero/customizer?medida=" + id_medida + "&ferramenta=" + filename + "&tipo=" + tipo + "&id_cor_tampa=" + id_cor_tampa + "&time=" + unix);
				        $("div#boxAprovacao img#mascaraGabarito").attr("src", "https://ecovasos.com/qero/personalize/img/area-sem-impressao/"+id_medida+".png")
...
;
    ...
    $('#grid').click(function(){
		...
		if (template.css("background-image") == "none") {
			template.css("background-image", 'url("./assets/site/images/grid.svg")')
...
// TUTORIAL //
    function TutorialSteps(stepNumber) {
        ...
        switch(step) {
            ...
            case 2:
                titleStep = 'Uploads';
                textStep = 'Sube tu logo, fotos o otros elementos sin limitaciÃ³n de colores para personalizar tu ecovaso.';
            ...
            case 3:
                ...
                textStep = 'Agrega elementos de nuestra galerÃ­a y textos personalizados.';
            ...
            case 6:
                titleStep = 'Vaso 3D';
                textStep = 'VisualizÃ¡ como quedarÃ¡ tu vaso 3D a cualquier momento.';
    ...
    setTimeout(function() {
		html2canvas(el, { scale: 2 }).then((canvas) => {
			...
			$.ajax({
				...
				data: { filename: filename, img: a.href, bg: bgGabarito, tipo: 'serigrafia', id_medida: id_medida },
				success: function (data) {
                    $("div#boxModelo iframe").attr("src", "https://ecovasos.com/qero/customizer?medida=" + id_medida + "&ferramenta=" + filename + "&tipo=" + tipo + "&id_cor_tampa=" + id_cor_tampa + "&time=" + unix);
				    $("div.ampliar-box-modelo a").attr("href", "https://ecovasos.com/qero/customizer?medida=" + id_medida + "&ferramenta=" + filename + "&tipo=" + tipo + "&id_cor_tampa=" + id_cor_tampa + "&time=" + unix)
